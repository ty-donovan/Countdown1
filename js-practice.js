...
const pos_neg = (num) => {num % 2 === 0 ? console.log("even") : console.log("odd")}
// pos_neg(8)
// pos_neg(13)
...
const get_day_message = (day) => {
    switch(day) {
        case "monday":
            console.log("good luck")
            break;
        case "tuesday":
            console.log("better than monday")
            break;
        case "wednesday":
            console.log("HUMPDAY")
            break;
...
// days.forEach((day) => get_day_message(day))
...
//     let running_sum = 0
//     nums.forEach(num => running_sum += num)
//     return running_sum
// }

// console.log(runsum(7))
